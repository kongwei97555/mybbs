...
public class Utils
{
 ...
 // public static Gson gson = new Gson();
  ...
  /**
   * 调用百度节假日api，查询某天是否节假日
   * 0为工作日，1为休息日，2为节假日
   * @param httpArg:参数 格式必须为20160827
   * @return 返回结果
   */
  public static String getCheckHoliday(String httpArg) {
    String httpUrl = "http://apis.baidu.com/xiaogg/holiday/holiday";//请求接口
    ...
    try {
      ...
      connection.setRequestProperty("apikey",  "0e6080aa7051027978f310ea8bd0d406");
      connection.connect();
